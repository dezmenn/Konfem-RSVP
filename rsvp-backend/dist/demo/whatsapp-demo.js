...
exports.demoWhatsApp = demoWhatsApp;
...
async function demoWhatsApp() {
    ...
    try {
        ...
        const whatsAppService = new WhatsAppMockService_1.WhatsAppMockService(mockRepo, {
        ...
        for (const guest of guests) {
            ...
            const result = await whatsAppService.sendMessage(guest.phone, personalizedContent, messageId);
        ...
        for (let i = 0; i < 7; i++) {
            ...
            const result = await whatsAppService.sendMessage(testPhone, `Rate limit test message ${i + 1}`, messageId);
...
//# sourceMappingURL=whatsapp-demo.js.map