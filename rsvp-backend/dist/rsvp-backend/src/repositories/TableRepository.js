...
class TableRepository extends BaseRepository_1.BaseRepository {
    ...
    async checkTableCapacity(tableId) {
        const query = `
      SELECT 
        t.capacity,
        COUNT(g.id) as occupied
