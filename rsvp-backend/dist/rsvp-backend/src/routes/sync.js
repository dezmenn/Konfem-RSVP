...
const SyncQueueService_1 = require("../services/SyncQueueService");
const logger_1 = require("../utils/logger");
const router = express_1.default.Router();
const syncQueueService = SyncQueueService_1.SyncQueueService.getInstance();
...
router.post('/operations', (req, res) => {
    try {
        ...
        logger_1.logger.error('Failed to add sync operation:', error);
...
router.post('/retry-failed', async (req, res) => {
    try {
        ...
        logger_1.logger.error('Failed to retry operations:', error);
...
router.post('/conflicts/:operationId/resolve', async (req, res) => {
    try {
        ...
        logger_1.logger.error('Failed to resolve conflict:', error);
...
router.delete('/completed', (req, res) => {
    try {
        ...
        logger_1.logger.error('Failed to clear completed operations:', error);
...
router.get('/events/:eventId/pending', (req, res) => {
    try {
        ...
        logger_1.logger.error('Failed to get pending operations:', error);
