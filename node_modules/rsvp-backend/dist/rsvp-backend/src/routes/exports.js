...
const MockTableService_1 = require("../services/MockTableService");
const MockVenueElementRepository_1 = require("../services/MockVenueElementRepository");
const router = express_1.default.Router();
// Initialize repositories and service based on environment
let guestRepository;
let tableRepository;
let venueElementRepository;
if (process.env.SKIP_DB_SETUP === 'true') {
    // Use mock services for demo mode
    guestRepository = new MockGuestRepository_1.MockGuestRepository();
    tableRepository = new MockTableService_1.MockTableService();
    venueElementRepository = new MockVenueElementRepository_1.MockVenueElementRepository();
}
else {
    // Use real repositories for production
    guestRepository = new GuestRepository_1.GuestRepository();
    tableRepository = new TableRepository_1.TableRepository();
    venueElementRepository = new VenueElementRepository_1.VenueElementRepository();
}
const exportService = new ExportService_1.ExportService(guestRepository, tableRepository, venueElementRepository);
/**
