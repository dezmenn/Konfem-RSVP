...
let whatsAppMockService: WhatsAppMockService;

export const setWhatsAppMockService = (service: WhatsAppMockService) => {
...
router.post('/clear-rate-limits', (req: Request, res: Response) => {
  try {
