...
export const mockContactsWithFormattedPhones: ContactData[] = [
  {
...
export const mockInvalidContacts = [
  {
    id: 'invalid-1',
    name: '', // Missing name
...
export const sampleCSVContent = `name,phoneNumber,dietaryRestrictions,additionalGuestCount,relationshipType,brideOrGroomSide,specialRequests
...
export const invalidCSVContent = `name,phoneNumber,dietaryRestrictions,additionalGuestCount,relationshipType,brideOrGroomSide,specialRequests
...
export const malformedCSVContent = 'This is not a proper CSV file structure';

export const emptyCSVContent = 'name,phoneNumber\n'; // Header only

export const csvWithSpecialCharacters = `name,phoneNumber,dietaryRestrictions,additionalGuestCount,relationshipType,brideOrGroomSide,specialRequests
